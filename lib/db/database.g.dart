...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  static const VerificationMeta _avatarColorIndexMeta = const VerificationMeta(
    'avatarColorIndex',
  );
  @override
  late final GeneratedColumn<int> avatarColorIndex = GeneratedColumn<int>(
    'avatar_color_index',
    aliasedName,
    false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('avatar_color_index')) {
      context.handle(
        _avatarColorIndexMeta,
        avatarColorIndex.isAcceptableOrUnknown(
          data['avatar_color_index']!,
          _avatarColorIndexMeta,
        ),
      );
    }
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      avatarColorIndex: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}avatar_color_index'],
      )!,
...
class User extends DataClass implements Insertable<User> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['avatar_color_index'] = Variable<int>(avatarColorIndex);
  ...
  UsersCompanion toCompanion(bool nullToAbsent) {
    return UsersCompanion(
      ...
      avatarRef: avatarRef == null && nullToAbsent
          ? const Value.absent()
          : Value(avatarRef),
      avatarColorIndex: Value(avatarColorIndex),
  ...
  factory User.fromJson(
    ...
    return User(
      ...
      avatarColorIndex: serializer.fromJson<int>(json['avatarColorIndex']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'avatarColorIndex': serializer.toJson<int>(avatarColorIndex),
  ...
  User copyWithCompanion(UsersCompanion data) {
    return User(
      ...
      avatarColorIndex: data.avatarColorIndex.present
          ? data.avatarColorIndex.value
  ...
  String toString() {
    return (StringBuffer('User(')
          ...
          ..write('avatarColorIndex: $avatarColorIndex, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is User &&
          ...
          other.avatarColorIndex == this.avatarColorIndex &&
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  final Value<int> avatarColorIndex;
  ...
  const UsersCompanion({
    ...
    this.avatarColorIndex = const Value.absent(),
  ...
  static Insertable<User> custom({
    ...
    Expression<int>? avatarColorIndex,
    ...
    return RawValuesInsertable({
      ...
      if (avatarColorIndex != null) 'avatar_color_index': avatarColorIndex,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (avatarColorIndex.present) {
      map['avatar_color_index'] = Variable<int>(avatarColorIndex.value);
    }
    if (deviceId.present) {
...
class $SplitsTable extends Splits with TableInfo<$SplitsTable, Split> {
  ...
  static const VerificationMeta _owedShareMeta = const VerificationMeta(
    'owedShare',
  );
  @override
  late final GeneratedColumn<double> owedShare = GeneratedColumn<double>(
    'owed_share',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('owed_share')) {
      context.handle(
        _owedShareMeta,
        owedShare.isAcceptableOrUnknown(data['owed_share']!, _owedShareMeta),
      );
    } else if (isInserting) {
      context.missing(_owedShareMeta);
    }
  ...
  Split map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Split(
      ...
      owedShare: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}owed_share'],
      )!,
...
class Split extends DataClass implements Insertable<Split> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['owed_share'] = Variable<double>(owedShare);
  ...
  factory Split.fromJson(
    ...
    return Split(
      ...
      owedShare: serializer.fromJson<double>(json['owedShare']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'owedShare': serializer.toJson<double>(owedShare),
  ...
  Split copyWithCompanion(SplitsCompanion data) {
    return Split(
      ...
      owedShare: data.owedShare.present ? data.owedShare.value : this.owedShare,
  ...
  bool operator ==(Object other) =>
      ...
      (other is Split &&
          ...
          other.owedShare == this.owedShare &&
...
class SplitsCompanion extends UpdateCompanion<Split> {
  ...
  const SplitsCompanion({
    ...
    this.owedShare = const Value.absent(),
  ...
  static Insertable<Split> custom({
    ...
    return RawValuesInsertable({
      ...
      if (owedShare != null) 'owed_share': owedShare,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (owedShare.present) {
      map['owed_share'] = Variable<double>(owedShare.value);
    }
    if (rawInput.present) {
...
abstract class _$ZplitDatabase extends GeneratedDatabase {
  _$ZplitDatabase(QueryExecutor e) : super(e);
  $ZplitDatabaseManager get managers => $ZplitDatabaseManager(this);
...
class $$UsersTableFilterComposer
    extends Composer<_$ZplitDatabase, $UsersTable> {
  ...
  ColumnFilters<int> get avatarColorIndex => $composableBuilder(
    column: $table.avatarColorIndex,
    builder: (column) => ColumnFilters(column),
  );
...
class $$UsersTableOrderingComposer
  ...
  ColumnOrderings<int> get avatarColorIndex => $composableBuilder(
    column: $table.avatarColorIndex,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$UsersTableAnnotationComposer
  ...
  GeneratedColumn<int> get avatarColorIndex => $composableBuilder(
    column: $table.avatarColorIndex,
    builder: (column) => column,
  );
...
class $$UsersTableTableManager
    extends
        RootTableManager<
          ...
          (User, BaseReferences<_$ZplitDatabase, $UsersTable, User>),
          User,
          PrefetchHooks Function()
        > {
  $$UsersTableTableManager(_$ZplitDatabase db, $UsersTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> avatarRef = const Value.absent(),
                Value<int> avatarColorIndex = const Value.absent(),
...
class $$GroupsTableFilterComposer
    extends Composer<_$ZplitDatabase, $GroupsTable> {
...
class $$GroupsTableTableManager
    extends
        RootTableManager<
          ...
          (Group, BaseReferences<_$ZplitDatabase, $GroupsTable, Group>),
          Group,
          PrefetchHooks Function()
        > {
  $$GroupsTableTableManager(_$ZplitDatabase db, $GroupsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$ExpensesTableFilterComposer
    extends Composer<_$ZplitDatabase, $ExpensesTable> {
...
class $$ExpensesTableTableManager
    extends
        RootTableManager<
          ...
          (Expense, BaseReferences<_$ZplitDatabase, $ExpensesTable, Expense>),
          Expense,
          PrefetchHooks Function()
        > {
  $$ExpensesTableTableManager(_$ZplitDatabase db, $ExpensesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$SplitsTableFilterComposer
    extends Composer<_$ZplitDatabase, $SplitsTable> {
  ...
  ColumnFilters<double> get owedShare => $composableBuilder(
    column: $table.owedShare,
    builder: (column) => ColumnFilters(column),
  );
...
class $$SplitsTableOrderingComposer
  ...
  ColumnOrderings<double> get owedShare => $composableBuilder(
    column: $table.owedShare,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$SplitsTableAnnotationComposer
  ...
  GeneratedColumn<double> get owedShare =>
      $composableBuilder(column: $table.owedShare, builder: (column) => column);
...
class $$SplitsTableTableManager
    extends
        RootTableManager<
          ...
          (Split, BaseReferences<_$ZplitDatabase, $SplitsTable, Split>),
          Split,
          PrefetchHooks Function()
        > {
  $$SplitsTableTableManager(_$ZplitDatabase db, $SplitsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<double> owedShare = const Value.absent(),
...
class $ZplitDatabaseManager {
  final _$ZplitDatabase _db;
  $ZplitDatabaseManager(this._db);
